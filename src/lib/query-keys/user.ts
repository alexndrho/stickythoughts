export const userKeys = {
  ...
  notificationsInfinite: () =>
    [...userKeys.notifications(), "infiniteNotifications"] as const,
  notificationCount: () =>
    [...userKeys.notifications(), "count"] as const,
  ...
  infiniteLikes: (username: string) =>
    [...userKeys.byUsername(username), "infiniteLikes"] as const,
};
