...
export interface SubmittedThoughtsTabProps {
  isActive: boolean;
}

export default function SubmittedThoughtsTab({ isActive }: SubmittedThoughtsTabProps) {
  ...
  const { data: thoughts, isFetching } = useQuery({
    ...submittedThoughtsPageOptions(page),
    enabled: isActive,
  });

  const { data: totalCount } = useQuery({
    ...submittedThoughtsCountOptions(),
    enabled: isActive,
  });
