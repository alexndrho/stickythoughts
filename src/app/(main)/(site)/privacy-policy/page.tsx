  ...
  return (
    <>
      ...
      <Text mt="md">
        ...
        means the https://www.stickythoughts.app/ website operated by StickyThoughts.
      </Text>
      <Text mt="md">
        <Text span fw="bold">
          PERSONAL DATA
      ...
      <Text mt="md">0.4. Address, Country, State, Province, ZIP/Postal code, City</Text>
      ...
      <Text mt="md">
        ...
        Advertising Cookies are used to serve you with advertisements that may be relevant to you
        and your interests.
      </Text>
      <Text mt="md">
        <Text span fw="bold">
      ...
      <Text mt="md">
        ...
        <Anchor href="https://policymaker.io/non-disclosure-agreement/">NDA agreements</Anchor>,
        information on bonuses and compensation, information on marital status, family members,
        social security (or other taxpayer identification) number, office location and other data.
      </Text>
      <Text mt="md">
        5.{' '}
        <Text span fw="bold">
      ...
      <Text mt="md">StickyThoughts uses the collected data for various purposes:</Text>
      <Text mt="md">0.1. to provide and maintain our Service;</Text>
      <Text mt="md">0.2. to notify you about changes to our Service;</Text>
      <Text mt="md">
        0.3. to allow you to participate in interactive features of our Service when you choose to
        do so;
      </Text>
      ...
      <Text mt="md">0.8. to fulfil any other purpose for which you provide it;</Text>
      <Text mt="md">
        0.9. to carry out our obligations and enforce our rights arising from any contracts entered
      ...
      <Text mt="md">0.12. in any other way we may describe when you provide the information;</Text>
      ...
      <Text mt="md">
        ...
        that we transfer the data, including Personal Data, to Philippines and process it there.
      </Text>
      <Text mt="md">
      ...
      <Text mt="md">
        StickyThoughts will take all the steps reasonably necessary to ensure that your data is
      ...
      <Text mt="md">We may disclose personal information that we collect, or you provide:</Text>
      <Text mt="md">
        0.1.{' '}
        <Text span fw="bold">
      ...
      <Text mt="md">0.3.3. to fulfill the purpose for which you provide it;</Text>
      <Text mt="md">
      ...
      <Text mt="md">
        0.3.7. if we believe disclosure is necessary or appropriate to protect the rights, property,
      ...
      <Text mt="md">In certain circumstances, you have the following data protection rights:</Text>
      <Text mt="md">
      ...
      <Text mt="md">
        0.3. the right to object. You have the right to object to our processing of your Personal
        Data;
      </Text>
      <Text mt="md">
        0.4. the right of restriction. You have the right to request that we restrict the processing
      ...
      <Text mt="md">
        <Text span fw="bold">
          0.1. What personal information we have about you. If you make this request, we will return
          to you:
        </Text>
      </Text>
      <Text mt="md">
      ...
      <Text mt="md">
        0.0.7. A list of categories of personal information that we have disclosed for a business
      ...
      <Text mt="md">
        <Text span fw="bold">
          ...
          personal information we hold about you as of the date of your request from our records and
          direct any service providers to do the same. In some cases, deletion may be accomplished
          through de-identification of the information. If you choose to delete your personal
          information, you may not be able to use certain functions that require your personal
      ...
      <Text mt="md">
        <Text span fw="bold">
          ...
          information to any third parties for any purpose. We do not sell your personal information
          ...
          consideration may be considered a “sale” under California law. You are the only owner of
      ...
      <Text mt="md">
        ...
        ), provide Service on our behalf, perform Service-related services or assist us in analysing
      ...
      <Text mt="md">
        ...
        <Anchor href="https://policymaker.io/privacy-policy/">privacy policy</Anchor> has been made
        using <Anchor href="https://policymaker.io/">PolicyMaker.io</Anchor>, a free tool that helps
        create high-quality legal documents. PolicyMaker&apos;s{' '}
        <Anchor href="https://policymaker.io/privacy-policy/">privacy policy generator</Anchor> is
        an easy-to-use tool for creating a{' '}
        <Anchor href="https://policymaker.io/blog-privacy-policy/">privacy policy for blog</Anchor>,
