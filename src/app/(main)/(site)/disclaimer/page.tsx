  ...
  return (
    <>
      ...
      <Text my="md">
        ...
        <Anchor href="https://policymaker.io/disclaimer/">Disclaimer</Anchor> has been created using{' '}
        <Anchor href="https://policymaker.io/">PolicyMaker.io</Anchor>, a free web application for
        generating high-quality legal documents. PolicyMaker’s{' '}
        <Anchor href="https://policymaker.io/disclaimer/">disclaimer generator</Anchor> is an
        easy-to-use tool for creating an excellent sample Disclaimer template for a website, blog,
        eCommerce store or app.
      </Text>
      <Text my="md">
      ...
      <Text my="md">
        The Site may contain links to affiliate websites, and we may receive an affiliate commission
        for any purchases or actions made by you on the affiliate websites using such links.
      </Text>
      <Text my="md">
        <Text span fw="bold">
      ...
      <Text my="md">
        ...
        been obtained from reliable sources, StickyThoughts is not responsible for any errors or
        omissions or for the results obtained from the use of this information. All information in
        this site is provided “as is”, with no guarantee of completeness, accuracy, timeliness or of
      ...
      <Text my="md">
        In no event will StickyThoughts, its related partnerships or corporations, or the partners,
      ...
      <Text my="md">
        This Site may include content from guest contributors and any views or opinions expressed in
        such posts are personal and do not represent those of StickyThoughts or any of its staff or
      ...
      <Text my="md">
        All logos and trademarks of third parties referenced on https://www.stickythoughts.app/ are
        the trademarks and logos of their respective owners. Any inclusion of such trademarks or
      ...
      <Text my="md">
        Should you have any feedback, replies, requests for technical support or other inquiries,
