...
export default function TermsAndConditionsPage() {
  return (
    <>
      ...
      <Text my="md">
        Content found on or through this Service are the property of StickyThoughts or used with
      ...
      <Text my="md">
        ...
        enjoyment of Service, or which, as determined by us, may harm or offend Company or users of
      ...
      <Text my="md">0.8. Take any action that may damage or falsify Company rating.</Text>
      <Text my="md">0.9. Otherwise attempt to interfere with the proper working of Service.</Text>
      <Text my="md">
        6.{' '}
        <Text span fw="bold">
          Analytics
      ...
      <Text my="md">
        ...
        functionality are and will remain the exclusive property of StickyThoughts and its
        licensors. Service is protected by copyright, trademark, and other laws of and foreign
        countries. Our trademarks may not be used in connection with any product or service without
        the prior written consent of StickyThoughts.
      </Text>
      <Text my="md">
        9.{' '}
        <Text span fw="bold">
      ...
      <Text my="md">
        ...
        submit your claim via email to ho.alexander.g@gmail.com, with the subject line: “Copyright
      ...
      <Text my="md">0.4. your address, telephone number, and email address;</Text>
      <Text my="md">
      ...
      <Text my="md">
        You can contact our Copyright Agent via email at ho.alexander.g@gmail.com.
      </Text>
      <Text my="md">
        11.{' '}
        <Text span fw="bold">
      ...
      <Text my="md">
        You may provide us either directly at ho.alexander.g@gmail.com or via third party sites and
      ...
      <Text my="md">
        ...
        controlled by StickyThoughts.
      </Text>
      <Text my="md">
        StickyThoughts has no control over, and assumes no responsibility for the content, privacy
      ...
      <Text my="md">
        ...
        <Anchor href="https://policymaker.io/terms-and-conditions/">Terms of Use</Anchor> have been
        created using <Anchor href="https://policymaker.io/">PolicyMaker.io</Anchor>, a free web
        ...
        is an easy-to-use free tool for creating an excellent standard Terms of Service template for
      ...
      <Text my="md">
        These Terms shall be governed and construed in accordance with the laws of Philippines,
