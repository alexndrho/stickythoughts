...
export default function UpdateBioModal({ opened, onClose, defaultValue }: UpdateEmailModalProps) {
  const form = useForm({
    initialValues: {
      bio: defaultValue || '',
    },
  ...
  const mutation = useMutation({
    ...
    onError: (error) => {
      if (error instanceof ServerError) {
        ...
        form.setFieldError('bio', 'An unexpected error occurred. Please try again.');
      }
    },
  });
