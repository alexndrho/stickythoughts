  ...
  return (
    ...
    >
      {!backupCodes || backupCodes.length === 0 ? (
        ...
        <>
          <Text mb="md">
            Here are your backup codes. Each code can be used once to access
            your account if you lose access to your two-factor authentication
            method. Please store them in a safe place.
          </Text>
          ...
          <SimpleGrid cols={2}>
            {backupCodes?.map((code) => (
              <Paper
                key={code}
                withBorder
                className={classes["backup-codes-modal__code"]}
              >
        ...
        <>
          <Text>
            Are you sure you want to close? Make sure you have saved your backup
            codes in a safe place before closing.
          </Text>
