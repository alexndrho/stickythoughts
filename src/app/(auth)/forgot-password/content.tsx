  ...
  return (
    <>
      ...
      <Stepper active={activeStep} onStepClick={setActiveStep} allowNextStepsSelect={false}>
        <Stepper.Step label="Enter your email" description="We will send you a verification code">
          <StepOne setEmail={setEmail} nextStep={nextStep} />
        </Stepper.Step>

        <Stepper.Step label="Enter verification code" description="We sent you a code">
          <StepTwo
            email={email}
        ...
        <Stepper.Step label="Set new password" description="Choose a new password">
          <StepThree
            email={email}
